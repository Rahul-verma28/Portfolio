    ...
    <footer className="w-full border-t-2 py-8 px-4 md:px-8 bg-gray-100 dark:bg-[#1a1b1e] text-[#333333] dark:text-white transition-colors duration-300">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-4 cursor-pointer">
          <Link href="https://www.linkedin.com/in/rahul-verma-09227a263/" rel="noopener noreferrer" legacyBehavior>
            <a target="_blank" className="hover:text-primary dark:hover:text-primary-light transition-colors">
          ...
          <Link href="https://github.com/Rahul-verma28" rel="noopener noreferrer" legacyBehavior>
            <a target="_blank" className="hover:text-primary dark:hover:text-primary-light transition-colors">
          ...
          <Link href="mailto: rahulverma281202@gmail.com" rel="noopener noreferrer" legacyBehavior>
            <a target="_blank" className="hover:text-primary dark:hover:text-primary-light transition-colors">
