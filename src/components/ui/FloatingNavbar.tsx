        ...
        <>
            <AnimatePresence>
                <motion.nav
                    ...
                    className={`fixed top-4 inset-x-0 mx-auto z-[5000] max-w-3xl px-4 ${scrolled ? "" : ""
                        }`}
                >
                    <div
                        className={`flex items-center justify-between rounded-2xl border px-5 py-3 transition-all duration-300 ${scrolled
                                ? "border-white/[0.08] bg-white/80 dark:bg-neutral-950/80 backdrop-blur-xl shadow-lg shadow-black/5"
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                            <Link
                                ...
                                className="hidden md:inline-flex items-center gap-2 rounded-full bg-violet-600 hover:bg-violet-700 px-4 py-2 text-sm font-medium text-white transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/25"
                            >
                                Let&apos;s Connect
                            </Link>
                    ...
                    <AnimatePresence>
                        {mobileOpen && (
                            <motion.div
                                ...
                                className="mt-2 rounded-2xl border border-white/[0.08] bg-white/95 dark:bg-neutral-950/95 backdrop-blur-xl p-4 shadow-xl md:hidden"
                            >
