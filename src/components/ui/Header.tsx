...
const Header = () => {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        <h1 className="text-2xl dark:text-white hover:underline uppercase flex items-center gap-2"><Image src="/image.png" className=" rounded-full" width={40} height={40} alt="Logo"/>Rahul.</h1>
