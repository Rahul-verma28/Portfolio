                ...
                <div className="relative z-10 flex flex-col items-center">
                    <motion.div
                        className={`w-4 h-4 rounded-full border-2 ${experience.current
                                ...
                                : "border-violet-500/50 bg-neutral-950 dark:bg-neutral-900"
                            }`}
                ...
                <div className="relative flex flex-col items-center mr-6">
                    <motion.div
                        className={`w-3 h-3 rounded-full border-2 flex-shrink-0 ${experience.current
                                ? "border-violet-500 bg-violet-500 glow-violet-sm"
                                : "border-violet-500/50 bg-neutral-950"
                            }`}
                    />
                    {!isLast && (
...
function TimelineCard({
    ...
    return (
        <motion.div
            className="group relative overflow-hidden rounded-xl border border-white/[0.08] bg-white/[0.02] dark:bg-white/[0.02] backdrop-blur-sm p-5 md:p-6 transition-all duration-300 hover:border-violet-500/20 hover:bg-white/[0.05]"
            whileHover={{ y: -2 }}
        >
            {/* Period badge */}
